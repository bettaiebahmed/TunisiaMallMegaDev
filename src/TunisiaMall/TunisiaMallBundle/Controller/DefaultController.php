...
//         $libelle = $request->;
        $boutiques = $em->getRepository('TunisiaMallBundle:Enseigne')->findAll();
        ...
        if (( $this->container->get('security.context')->isGranted('IS_AUTHENTICATED_FULLY'))) {
            ...
            if ($validite == "valide") {
                ...
                listmagazinAction();
                return $this->render('TunisiaMallBundle:Default:index.html.twig', array("magazins" => $boutiques,'csrf_token' => $csrfToken, 'product' => $article));
    ...
    public function contactAction() { {
            ...
            if (( $this->container->get('security.context')->isGranted('IS_AUTHENTICATED_FULLY'))) {
                ...
                if ($validite == "valide") {
                    return $this->render('TunisiaMallBundle:Default:contact.html.twig', array("magazins" => $boutiques,'csrf_token' => $csrfToken));
                    $stat = new Stat();
                    $stat->compter();
                } else if ($validite == "refuser") {
                    echo "impossible";
    ...
    public function visitemallAction() {
        return $this->render('TunisiaMallBundle:Default:Visitevirtuelle.html.twig');
    }
